...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{capturarterminal.png}
	\caption{Escena: escenacilindroMayorPared.ttt}
\end{figure}
...
\begin{figure}[!htb]
   \begin{subfigure}{0.48\textwidth}
     \centering
     \includegraphics[width=.7\linewidth]{Iteracion1.jpg}
     \caption{Iteración 1}
   \end{subfigure}\hfill
   \begin{subfigure}{0.48\textwidth}
     \centering
     \includegraphics[width=.7\linewidth]{Iteracion50.jpg}
